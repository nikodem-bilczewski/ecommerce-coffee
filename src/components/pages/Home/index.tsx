    ...
    <section className='my-16 mt-16 flex flex-col items-center gap-20 lg:flex-row lg:justify-center lg:gap-12'>
      <div>
        ...
        <h2 className='mb:font-thin text-3xl font-extralight xl:text-4xl '>
          We offer a wide variety of coffee blends to satisfy any coffee love's taste buds. Whether
          you prefer a rich, bold flavor or a smooth, mild taste, we have something for everyone.
        </h2>
      </div>
