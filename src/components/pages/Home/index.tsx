...
const Home = () => (
  <main className='mx-auto flex min-h-screen w-full sm:w-11/12 md:w-10/12 flex-col justify-evenly text-center'>
    <section className='my-16 mt-16 flex flex-col items-center gap-20 lg:flex-row lg:justify-center lg:gap-12'>
      <div>
        ...
        <h2 className='mx-20 text-3xl font-extralight mb:font-thin xl:text-4xl'>
    ...
    <section className='my-6 flex flex-col-reverse items-center gap-20 lg:flex-row lg:justify-center lg:gap-12'>
      ...
      />
      <div>
        <h1 className='mb-4 text-4xl font-bold lg:text-5xl'>Check our shop</h1>
        <h2 className='mx-20 mb-10 text-3xl font-extralight xl:text-4xl'>
          Visit our online store today and discover a world of premium coffee
          and accessories, all just a click away. Your coffee adventure awaits!
        </h2>
